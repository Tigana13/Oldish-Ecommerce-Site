...
$cat_row = mysqli_fetch_assoc($run_cat_title);

$cat_title = $cat_row['cat_title'];

$get_cat_pros = "SELECT * FROM products WHERE product_category='$cat_title'";
$run_cat_pros = mysqli_query($con, $get_cat_pros);
mysqli_num_rows($run_cat_pros);
...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="<?php if (isset($_GET['uid'])){
							 ...
							 ?>">Home</a><label>/</label>Products<label>/</label>All</h3>
		<div class="clearfix"> </div>
	</div>
</div>
	<!--content-->
	...
	<?php 
			...
			$product_row_count = mysqli_num_rows($run_cat_pros);
			...
			if (isset($_GET['uid'])) {
				while ($row_cat_pros=mysqli_fetch_assoc($run_cat_pros)) {
				$product_id = $row_cat_pros['product_id'];
				$product_name = $row_cat_pros['product_name'];
				$product_category = $row_cat_pros['product_category'];
				$product_price = $row_cat_pros['product_price'];
				$product_description = $row_cat_pros['product_desc'];
				$product_image1 = $row_cat_pros['product_img1'];
				$product_image2 = $row_cat_pros['product_img2'];
